        ...
        <div class="h-text">
            ...
            <div class="h-body">
                ...
                <div class="h-buttons">
                    ...
                    <Button onClick={() => console.log("go to hire me")}>
                        Hire Me
                    </Button>
                </div>
            </div>
            <div class="h-footer">
                <div class="h-footer-icons">
                    <div class="h-f-i-icon h-f-i-phone">
                        <svg
                            viewBox="0 0 24 24"
                            fill="none"
...
<!------------------------------------------------------------------------ CSS ------------------------------------------------------------------------->
<style>
    .h-section-one, .h-section-two, .h-section-three, .h-section-four{
        margin-left: 10%;
        margin-right: 10%;
        margin-bottom: 5rem;
    }
